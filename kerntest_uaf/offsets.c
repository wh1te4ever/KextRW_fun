...
uint64_t ksymbols_avm1_24d81_kdk_kasan[] = {
    0xFFFFFE000780C900, // KSYMBOL_KERNPROC
    0xFFFFFE000B33A59C, // KSYMBOL_RET_1024
    0xFFFFFE000862CCB0, // KSYMBOL_phystokv
    0xFFFFFE00085DB928, // KSYMBOL_kvtophys
    0xFFFFFE0007768048, // KSYMBOL_ptov_table
    0xFFFFFE0007768108, // KSYMBOL_gPhysBase
    0xFFFFFE0007768120, // KSYMBOL_gPhysSize
    0xFFFFFE0007768118, // KSYMBOL_gVirtBase
    0xFFFFFE0007764840, // KSYMBOL_cpu_ttep
    0xFFFFFE00085D911C, // KSYMBOL_pmap_enter_options_addr
    0xFFFFFE00085C22F8, // KSYMBOL_pmap_remove_options
    0xFFFFFE0007764848, // KSYMBOL_vm_first_phys
    0xFFFFFE0007764908, // KSYMBOL_pv_head_table
    0xFFFFFE00085DB018, // KSYMBOL_pmap_find_pa
};
...
void offsets_init(void) {
    ...
    if (strcmp(kern_version, AVM1_24D81_KVERSION_KASAN) != 0 &&
        strcmp(kern_version, T8122_24E263_KVERSION) != 0 &&
    ...
    if (strcmp(kern_version, AVM1_24D81_KVERSION_KASAN) == 0) {
        ...
        symbols = ksymbols_avm1_24d81_kdk_kasan;
